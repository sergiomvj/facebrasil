    ...
    const fetchInitialData = async () => {
        ...
        const [articlesRes, categoriesRes] = await Promise.all([
            supabase
                .from('articles')
                .select(`
                    id, title, slug, status, published_at, views, created_at,
        ...
        <>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-slate-400 text-sm">Manage your editorial content</p>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
                ...
                <div className="relative min-w-[200px]">
                    ...
                    <select
                        className="w-full bg-slate-900/50 border border-white/10 rounded-xl py-2 pl-10 pr-4 text-sm text-white appearance-none focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all cursor-pointer"
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-white/5">
                                {filteredArticles.length === 0 ? (
                                    <tr>
                                        <td colSpan={6} className="p-8 text-center text-slate-500 italic">No articles found matching your criteria.</td>
                                    </tr>
